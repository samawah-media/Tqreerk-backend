...
def summarize_prompt(combined_text: str, language: str = "ar") -> str:
    ...
    return (
        ...
        "- trends: the 5 most significant directional patterns. "
        "Ignore minor or sector-specific sub-trends. "
        "For each: topic (max 6 words), direction (increasing/decreasing/stable/volatile/mixed), "
        "time_span (max 6 words), magnitude (max 8 words), "
