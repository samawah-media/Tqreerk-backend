...
namespace Taqreerk.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260428121546_Admin_ActionLogs")]
    partial class Admin_ActionLogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Taqreerk.Domain.Entities.AdminActionLog", b =>
                {
                    ...
                    b.HasIndex(new[] { "AdminUserId", "CreatedAt" }, "IX_admin_action_logs_AdminUserId_CreatedAt_desc")
                        .IsDescending(false, true)
                        .HasFilter("\"AdminUserId\" IS NOT NULL");

                    b.HasIndex(new[] { "TargetEntityType", "TargetEntityId", "CreatedAt" }, "IX_admin_action_logs_Target_CreatedAt_desc")
            ...
            modelBuilder.Entity("Taqreerk.Domain.Entities.ReportReview", b =>
                {
                    ...
                    b.HasIndex(new[] { "ReportId", "CreatedAt" }, "IX_report_reviews_ReportId_CreatedAt_desc")
                        .IsDescending(false, true);
